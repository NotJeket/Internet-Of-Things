...
void start_mdns_service()
{
    ...
    //set hostname
    mdns_hostname_set("esp32-rogoz.local");
    //set default instance
    mdns_instance_name_set("Rogoz ESP32 Thing");
}
        ...
        while (1) {
            ...
            // Data received
                ...
                if(strcmp(rx_buffer, "GPIO4=1") ==0)
                {
                    ...
                    ESP_LOGI(TAG,"Becul este apins" );
                }
                else if(strcmp(rx_buffer, "GPIO4=0") ==0)
                {
                    gpio_set_level(GPIO_OUTPUT_IO,0);
                    ESP_LOGI(TAG,"Becul este stins" );
                }
            }
...
void app_main(void)
{
    ...
    if (connected) {
        ...
        start_mdns_service();
        resolve_mdns_host("esp32-rogoz.local");
    }
}